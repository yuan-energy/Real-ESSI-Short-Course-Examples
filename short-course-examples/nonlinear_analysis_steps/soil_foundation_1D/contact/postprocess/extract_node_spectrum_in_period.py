...
ax1.set(xlabel = 'Period [s]', ylabel = 'Pseudo-Spectral Acceleration Sa [g]', title = 'Pseudo-Spectral Acceleration')
ax1.grid()

ax2.plot(period, dis_spec, 'k-', linewidth=3)  
ax2.set(xlabel = 'Period [s]', ylabel = 'Spectral Displacement [m]', title = 'Spectral Displacement')
ax2.grid()
plt.savefig( out_filename + "_period.pdf" )
plt.show()
