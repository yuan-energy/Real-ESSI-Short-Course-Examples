...
out_filename = prefix + "_node_" + str(nodetag) + "_" + sys.argv[3] + "_disp"
...
dis = h5fileID['/Model/Nodes/Generalized_Displacements'][()]
time = h5fileID['/time'][()]

target_dis_loc = IndexToOutput[nodetag]  + the_dof
target_dis = dis[target_dis_loc]
