...
# sed -i 's/soil_profile_filename\ =\ soil_profile_Vs_filename/soil_profile_filename\ =\ \"soil_profile_set1_Vs\.txt\"/' main.fei
# sed -i '/soil_profile_filename\ =\ \"soil_profile_set1_Vs\.txt\"/ a \ \ \/\/\ soil_profile_filename\ =\ \"soil_profile_set2_Vs\.txt\"/' main.fei
# sed -i '/soil_profile_filename\ =\ \"soil_profile_set2_Vs\.txt\"/ a \ \ \/\/\ soil_profile_filename\ =\ \"soil_profile_set3_Vs\.txt\"/' main.fei

# sed -i 's/soil_profile_filename\ =\ soil_profile_Vp_filename/soil_profile_filename\ =\ \"soil_profile_set1_Vp\.txt\"/' main.fei
# sed -i '/soil_profile_filename\ =\ \"soil_profile_set1_Vp\.txt\"/ a \ \ \/\/\ soil_profile_filename\ =\ \"soil_profile_set2_Vp\.txt\"/' main.fei
# sed -i '/soil_profile_filename\ =\ \"soil_profile_set2_Vp\.txt\"/ a \ \ \/\/\ soil_profile_filename\ =\ \"soil_profile_set3_Vp\.txt\"/' main.fei
