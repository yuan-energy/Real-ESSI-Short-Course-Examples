...
ax1.plot(refer_time, refer_acc, '--k', linewidth=3, label=' Bottom Motion')
ax1.plot(out_time, out_acc, '-k', linewidth=3, label=' Top Motion')
ax1.legend()
...
ax2.semilogx(refer_freq, refer_ampl, '--k', linewidth=3, label=' Bottom Motion')
ax2.semilogx(out_freq, out_ampl, '-k', linewidth=3, label=' Top Motion')
ax2.legend(loc=2)
