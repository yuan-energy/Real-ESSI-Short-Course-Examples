...
ax1.plot(refer_time, refer_acc, '-k', linewidth=3, label='Structural Top Motion')
ax1.plot(out_time, out_acc, '--k', linewidth=3, label='Foundation Bottom Motion')
ax1.legend()
...
ax2.semilogx(refer_freq, refer_ampl, '-k', linewidth=3, label='Structural Top Motion')
ax2.semilogx(out_freq, out_ampl, '--k', linewidth=3, label='Foundation Bottom Motion')
ax2.legend(loc=2)
