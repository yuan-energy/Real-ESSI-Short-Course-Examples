...
python postprocess/extract_node_disp.py DRM1D_motion.h5.feioutput 6 x

# plot acceleration in time and frequency domain at node # 6 in x direction.
python postprocess/extract_node_acce.py DRM1D_motion.h5.feioutput 6 x

# plot acceleration in time and frequency domain at node # 21 in x direction.
python postprocess/extract_node_acce.py DRM1D_motion.h5.feioutput 21 x

# plot response spectrum (pseudo acceleration/displacement) in frequencies at node # 6 in x direction.
python postprocess/extract_node_spectrum_in_freq.py DRM1D_motion.h5.feioutput 6 x

# plot response spectrum (pseudo acceleration/displacement) in periods at node # 6 in x direction.
python postprocess/extract_node_spectrum_in_period.py DRM1D_motion.h5.feioutput 6 x
